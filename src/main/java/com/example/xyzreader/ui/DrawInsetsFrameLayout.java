...
//FrameLayout should be used to hold a single child view, because it can be difficult to
...
public class DrawInsetsFrameLayout extends FrameLayout {
    ...
    private Rect mInsets; //holds coordinates on rectangle
    ...
    public void setInsetBackground(Drawable insetBackground) {
        ...
        if (insetBackground != null) {
            insetBackground.setCallback(this);//set animated drawable
        }
